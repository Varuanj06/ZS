...
class order_detail{
	...
	private $aramex_pdf;
	private $order_type;
	private $with_keyword_discount;
	private $keyword_discount_code;
	...
	public function __construct(){
		...
		$this->aramex_pdf 						= "";
		$this->order_type 						= "";
		$this->with_keyword_discount 			= "";
		$this->keyword_discount_code 			= "";
	}
	...
	public function get_aramex_pdf(){
		return $this->aramex_pdf;
	}

	public function set_aramex_pdf($aramex_pdf){
		$this->aramex_pdf = $aramex_pdf;
	}
	...
	public function get_with_keyword_discount(){
		return $this->with_keyword_discount;
	}

	public function set_with_keyword_discount($with_keyword_discount){
		$this->with_keyword_discount = $with_keyword_discount;
	}

	public function get_keyword_discount_code(){
		return $this->keyword_discount_code;
	}

	public function set_keyword_discount_code($keyword_discount_code){
		$this->keyword_discount_code = $keyword_discount_code;
	}
	...
	public function insert(){
		...
		try {
			...
			$stmt = $conn->prepare("
				insert into order_detail(id_order, id_order_detail, id_product, id_product_prestashop, color, size, qty, order_type, with_keyword_discount, keyword_discount_code) 
				values (:id_order, :id_order_detail, :id_product, :id_product_prestashop, :color, :size, :qty, :order_type, :with_keyword_discount, :keyword_discount_code) ");
			...
			$stmt->execute( array( 
				...
				":with_keyword_discount" 	=> $this->with_keyword_discount,
				":keyword_discount_code" 	=> $this->keyword_discount_code
			) );
	...
	public function mapea($obj){
		...
		$this->aramex_pdf  						= $obj->aramex_pdf;
		$this->order_type  						= $obj->order_type;
		$this->with_keyword_discount 			= $obj->with_keyword_discount;
		$this->keyword_discount_code 			= $obj->keyword_discount_code;
	...
	public function delete_espresso_products($id_order){
		global $conn;
		...
		try {
		    ...
		    echo 'ERROR - order_detail.php|delete_espresso_products: ' . $e->getMessage();
		    return false;
		}
	}
	...
	public function exists_with_espresso(){
		global $conn;
	...
	public function exists_with_keyword_discount(){
		global $conn;
		...
		try {
			...
			$stmt = $conn->prepare("
				...
				and color 					= :color
				and size 					= :size
				and with_keyword_discount 	= :with_keyword_discount ");
	...
	public function exists_with_espresso_and_with_keyword_discount(){
		global $conn;
	...
	public function exists_product_prestashop_in_order($id_order, $id_product_prestashop){
		...
		try {
		    ...
		    echo 'ERROR: - order_detail.php|exists_product_prestashop_in_order' . $e->getMessage();
		}
	}

	public function exists_keyword_discount_code($keyword_discount_code){
		global $conn;
		...
		try {
			...
			$stmt = $conn->prepare("
				select * 
				from order_detail 
				where keyword_discount_code = :keyword_discount_code 
				and (select status from `order` where id_order = order_detail.id_order) = 'ORDER FINISHED'");

			$stmt->execute(array(
					":keyword_discount_code"  	=> $keyword_discount_code
				));
		    ...
		    echo 'ERROR: - order_detail.php|exists_keyword_discount_code' . $e->getMessage();
		}
	}
	...
	public function update_aramex_pdf(){
		global $conn;
		...
		try {
			...
			$stmt = $conn->prepare("
				update order_detail
				set
					aramex_pdf 			= :aramex_pdf
				where id_order 			= :id_order
				and id_order_detail 	= :id_order_detail ");

			$stmt->execute( array( 
				":aramex_pdf" 			=> $this->aramex_pdf,
				":id_order" 			=> $this->id_order,
				":id_order_detail" 		=> $this->id_order_detail
			) );
		    ...
		    echo 'ERROR - order.php|update_aramex_pdf: ' . $e->getMessage();
		    return false;
		}
	}

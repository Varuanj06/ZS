	...
	/* ====================================================================== *
 	...
 	-->			
			...
			<?php }else if( $q != ''){ ?>
				...
				<?php if(isset($_GET['q']) && !isset($_GET['date']) && ( count($products) >= 100 || $show_collections == 'yes' ) ){ ?>
				...
				<?php }else{ ?>
					...
					<script>
						...
						$.get(url+'?set_gender=<?php echo $user_gender; ?>&q=<?php echo $q; ?>&size=<?php echo $lucky_size; ?>&id_tag=<?php echo $id_tag; ?>&usr=<?php echo $q_fb_user; ?>&date=<?php echo $date; ?>&popular=<?php echo $popular; ?>', function(rs){

...
-->		
	...
	<div id="grid_collections"> 
		...
		?>
			<div class="media-box" onclick="location.href='./?q=<?php echo $q; ?>&date=<?php echo $key; ?>&id_tag=<?php echo $id_tag; ?>&set_gender=<?php echo $user_gender; ?>'">
				<div class="collection_title">
					<div class="collection_title_content">
						<strong style="font-size:11px;">COLLECTION</strong>
						<br>
						<span style="font-size:20px;"><?php echo $count; ?></span>
						<!--

<?php
	...
	// GET ALL PRODUCTS
	$products = $espresso_products->get_search_limit($_GET['keyword'], $gender, $age, " order by love_count desc");
	...
	foreach ($products as $row){
		...
		if($cont >= $_GET['start'] && $cont < $_GET['start']+10){
		...
		$tmp 							= array();
		$tmp['id_product_prestashop'] 	= $id_product_prestashop;
...
//get_products_espresso.php?keyword=something&gender=male&age=&start=0
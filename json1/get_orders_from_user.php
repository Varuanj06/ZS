<?php
	...
	foreach ($orders as $row){
		...
		foreach ($details as $row) {
			...
			$tmp_details['order_type'] 			= $row->get_order_type();

			if($tmp_details['order_type'] == 'espresso'){
				$espresso_products->map($row->get_id_product());

				$tmp_details['img_url'] 			= $espresso_products->get_image_link();
				$tmp_details['product_name'] 		= $espresso_products->get_name();

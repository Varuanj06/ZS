		...
		<div class="content">
			...
			<form action="" method="post" name="form">
				...
				<p>
					...
					<textarea class="custom-input" name="keywords" id="keywords" maxlength="5000" placeholder="write keywords here, the keywords must have slashes between them (i.e. /cold/big/large/)"></textarea>
				</p>

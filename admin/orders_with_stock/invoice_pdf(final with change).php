	 ...
	 * ====================================================================== */    	
		 ...
		 * ====================================================================== */    		
			...
			for ($i=0; $i < $times; $i++) { 
				...
				$hash 						= ($row->get_id_order().$row->get_id_order_detail().$i)+777;

				$new_row 					= array();
				$new_row['qty'] 			= $i==0 ? $qty : 1;
				$new_row['product_name'] 	= $i==0 ? $product_name : "Campus Edition T Shirt (Flash Sale) - Item Number: $hash";
			 ...
			 * ====================================================================== */ 
				...
				$details_html .= '
					<tr>
						...
						<td style="border-collapse: collapse; '.$border_r.' '.$border_l.' '.$border_t.' '.$border_b.'" align="right">HSN code : 6206 40 00</td>

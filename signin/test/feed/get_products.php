...
-->		
	...
	<div class="filters_container">
		<ul class="custom-filter" id="sort">
			...
			<li><a href="#" data-sort-by="media-box-view-count">View Count</a></li>
		</ul>
                			...
                			<div class="row">
                				<div class="col-xs-6">
                					<?php if($active_session === true){ ?>
		                				...
		                				?>
			                			<a  style="font-size:9px;background:#c09853;" class="btn btn-primary btn-green btn-sm save_id_product" data-id-product="<?php echo $id_product; ?>">

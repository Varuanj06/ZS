...
<?php 
	...
	if($not_found_details != ""){
		$not_found_details = 	"<div class='alert alert-warning'>
									The following product/products you are ordering may not be in stock  currently and may require time to procure. If the product is not in stock you can opt for a refund
									<br><br>

...
class keyword{
	...
	public function insert(){
		...
		try {
			...
			$stmt = $conn->prepare("
				insert into keyword(keyword, image, genders, ages, status, profiles, description, discount_type, discount) 
				values (:keyword, :image, :genders, :ages, :status, :profiles, :description, :discount_type, :discount) ");

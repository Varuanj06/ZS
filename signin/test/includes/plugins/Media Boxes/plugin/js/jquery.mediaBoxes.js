 ...
 * ====================================================================== */    
     ...
     * ====================================================================== */
        ...
        $container.isotopeMB({
            ...
            hiddenStyle: { opacity: 0, transform: 'scale(0.4)' },
     ...
     * ====================================================================== */
        ...
        function fixLoadMoreButton(){
            ...
            /* The following lines are added for the product feed project ONLY, they are not part of the media boxes plugin */
            if( loadMoreButton.hasClass('media-boxes-no-more-entries')){
                jQuery('.see-pixels').show();
                jQuery('.show_me_more[data-current-profile="'+$container.attr('data-profile')+'"]').show();
            }else{
                jQuery('.see-pixels').hide();
                jQuery('.show_me_more[data-current-profile="'+$container.attr('data-profile')+'"]').hide();
            }
            if(typeof resize_little_thumbs == 'function'){
        ...
        loadMoreButton.on('click', function(){
            ...
            /* The following lines are added for the product feed project ONLY, they are not part of the media boxes plugin */
            if (typeof pixels_show_fb_login == 'function') { 

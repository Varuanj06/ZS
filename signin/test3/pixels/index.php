	...
	<div class="tabs-container">
		...
		<?php if(isset($_GET['pixel_keyword']) && $_GET['pixel_keyword']=='yes'){ ?>
			...
			<?php 
				...
				$till_date 	= date_create($pixel_keyword->get_expiry_date()." 00:00:00");
			...
			?>
			<div class="alert alert-success">This is a seasonal store and the products will be out of stock in <strong><?php echo $expiry_msg; ?></strong></div>

		<?php } ?>

		<div id="grid">
			<?php foreach ($get_pixels as $row) { ?>
				...
				<?php 
					...
					$current_image_link = str_replace(".220x220", "", $current_image_link);
				?>

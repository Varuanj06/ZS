					...
					<table class="table table-condensed table-bordered">
						...
						?>
									...
									<tr>
										...
										<td class="text-right">
											₹<?php echo number_format($order->get_total_amount()-$order->get_total_discount()-$order->get_total_discount_voucher(), 2); ?>
										</td>
										<td>
											...
											<table style="width:100%;">
												...
												?>
														<tr>
															...
															<td>
																<img style="height:40px !important;" src="<?php echo $product->get_image_link(); ?>" alt="">
															</td>

...
<?php require_once("../../classes/purchase_order_row.php"); ?>
	<?php require_once("../../admin227/head.php"); ?>
...
<body>
	...
	<?php 
		...
		if( isset($_POST['action']) && $_POST['action'] == '1' ){
			...
			foreach ($final_result as $row) {
				...
				$row->set_out_of_stock( isset($_POST[$row->get_id_row()."=>out_of_stock"])?'yes':'' );
				$row->set_discontinued( isset($_POST[$row->get_id_row()."=>discontinued"])?'yes':'' );
	...
	<?php require_once("../../admin227/bottom.php"); ?>

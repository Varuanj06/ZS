			...
			<?php }else if( $q != ''){ ?>
				...
				<?php }else{ ?>
					...
					<script>
						...
						$.get(url+'?set_gender=<?php echo $user_gender; ?>&q=<?php echo $q; ?>&size=<?php echo $lucky_size; ?>&id_tag=<?php echo $id_tag; ?>&usr=<?php echo $q_fb_user; ?>&date=<?php echo $date; ?>', function(rs){

	        ...
	        <div class="media-box <?php if(count($list_stock)>0){echo 'lucky_sizes';}else{echo 'normal_products';} ?>" style="display:none;">
	            ...
	            <div class="media-box-content" data-idproductprestashop="<?php echo $id_product_prestashop; ?>" data-idproduct="<?php echo $row->get_id_product(); ?>">
	                <div class="media-box-text" style="margin: 0 !important;">
	                	...
	                	<p>
	                		<?php echo $row->get_name(); ?> <?php echo $id_product; ?>
	                	</p>
                		...
                		<div class="row">
                			<div class="col-sm-12">
                				<a style="background:#c09853;" target="_blank" href="product_details.php?id_product=<?php echo $row->get_id_product(); ?><?php echo str_replace("?", "&", $extra_param); ?>" class="btn btn-md btn-green">View product</a>
                			</div>
                		</div>
							...
							<?php if($disable_things !== true){ ?>
								...
								<?php if(!$product_in_cart){ ?>
									<div class="add_controls">
	                					<a class="add_to_cart btn btn-md btn-green" href="#">Add to Cart</a>
								...
								<div class="added_controls" <?php if($product_in_cart){ echo 'style="display:block;"'; } ?>>
                					<a class="btn btn-md btn-green" href="../cart">View Your Cart</a>
                					<div class="success_added_to_cart" style="color:#3c763d;position:absolute;bottom:-24px">
                						<i class="fa fa-check"></i> Succesfully added to cart
                					</div>
                				</div>
                			<?php } ?>							
            			<?php }else{ ?>	
	                		<a class="add_to_cart_without_login btn btn-md btn-green" href="#">Add to Cart</a>
	                		<div class="combination_not_available" style="color:#d44950;position:absolute;bottom:-33px">
        						The selected product combination is not available. Please select a different color or size.
        					</div>
                		<?php } ?>
                			...
                			<div class="row">
                				<div class="col-xs-6">
                					<?php if($active_session === true){ ?>
		                				...
		                				?>
			                			<a  style="font-size:9px;background:#c09853;" class="btn btn-primary btn-green btn-sm save_id_product" data-id-product="<?php echo $id_product; ?>" data-saved="<i class='fa fa-check'></i>&nbsp; SAVED" data-notsaved="<i class='fa fa-plus'></i>&nbsp; SAVE FOR LATER"> 

...
class order{
	...
	public function insert(){
		...
		try {
			...
			$stmt = $conn->prepare("
				insert into `order`(id_order, id_fb_user, status, date_add, date_update, status_admin, payment_method, online_payment, payed, courier_allocation, total_amount, total_discount, total_discount_voucher, free_order, payu_transaction, razorpay_order, paytm_checksum, paytm_id_order, gift_shipped) 

...
(function( window, $, undefined ){
     ...
     * ====================================================================== */
        ...
        delegate = ".mb-open-popup[data-mfp-src]"; // ADDED THIS LINE

        if(settings.magnificPopup){

            $container.find('.media-box, .media-box-hidden').each(function(){ // ADDED THIS LINE
                
                $(this).magnificPopup({ // MODIFIED THIS LINE

<?php
	...
	function get_admin_msg($new_step){
		...
		if($new_step == '2'){
    		...
    		$admin_msg = 'Please share your payment id and email id, we will check in our system and get back to you very soon. Or you can contact us directly at 080 4611 3033';
    	}else if($new_step == '28'){
